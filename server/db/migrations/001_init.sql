...
CREATE TABLE snapshot_lines (
  ...
  units_shipped_t7  INTEGER NOT NULL DEFAULT 0,
  units_shipped_t30 INTEGER NOT NULL DEFAULT 0,
  units_shipped_t60 INTEGER NOT NULL DEFAULT 0,
  units_shipped_t90 INTEGER NOT NULL DEFAULT 0,
